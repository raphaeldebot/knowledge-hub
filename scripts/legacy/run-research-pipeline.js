...
const { validateFactsDocument } = require("./facts-contract");
const {
  validateMarkdownAgainstFacts,
} = require("./markdown-from-facts");
...
function buildSteps(options) {
  ...
  return [
    ...
    },
    {
      ...
      script: "scripts/legacy/extract-facts-with-ollama.js",
      args: [
        options.slug,
        "--topic",
        options.topic,
    ...
    },
    {
      ...
      script: "scripts/legacy/generate-note-from-facts.js",
      args: [
        "--input",
        factsPath,
        "--output",
